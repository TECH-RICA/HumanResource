...
export default function Performance() {
      ...
      content: (
        <div className="performance-chart-section">
          <div className="performance-chart-header">
            <div className="performance-chart-title">Rating Distribution</div>
            <div className="performance-chart-subtitle">Employee performance ratings</div>
          </div>
  ...
  return (
    <div className="page-container performance-container">
      <div className="page-header">
        <div><h1>Performance</h1><p className="page-header-subtitle">Track employee performance and reviews</p></div>
        <Button icon={HiOutlineStar} className="performance-action-btn">New Review</Button>
      </div>
      <div className="performance-stats-grid mb-6">
